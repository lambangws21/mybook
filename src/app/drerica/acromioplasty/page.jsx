...
import myImage from "./img/acromioplasty.JPG";
import ocilating from "./img/ocilating.JPG";
import Card from "../../../components/card";
const AcromioplastyRotatorCuffRepair = () => {
  ...
  return (
    ...
    <div className="text-start ">
      ...
      <div className="mb-4 flex items-center  p-2">
        ...
        <div>
          <Image src={ocilating} alt="ocilating" className="hover:scale-150 duration-700 w-96 -ml-11" />
        </div>
      </div>
      <div className="mb-5 flex gap-4">
        ...
        <div className="hover:scale-150 duration-700">
          <Image src={myImage} alt="acromioplasty" />
        </div>
      </div>
...
export default AcromioplastyRotatorCuffRepair;
