...
import elbow1 from './img/Elbow1.JPG'
import elbow2 from './img/elbow2.JPG'

const ArthroscopiElbow = () => {
    ...
    return (
      ...
      <div className="text-start ">
        ...
        <div className='mb-4 flex flex-1 gap-20 justify-center'>
            <Image src={elbow1} alt="ocilating" className="hover:scale-150 duration-700 w-96 -ml-11" />
            <Image src={elbow2} alt="ocilating" className="hover:scale-150 duration-700 w-96 -ml-11" />
          </div>
        <div className="mb-4">
...
export default ArthroscopiElbow